...
* trace\_payload - \[0x32 0x04 0x00 0x00 0x02\]
...
* trace\_payload - \[0x32 0x04 0x00 0x00 0x02\] carried via ATDATA bus.
...
* This example has no timestamp
* A 2-bit type field with ’10’ meaning instruction trace
* trace\_payload - \[0xBD 0xAA 0xAA 0x68 0x00 0x00 0x20\]
...
* This example has no timestamp
* No type field (encoder has no data trace support)
* trace\_payload - \[0xBD 0xAA 0xAA 0x68 0x00 0x00 0x20\] carried via the ATDATA bus
...
* This example has no timestamp
* A 2-bit type field with ’10’ meaning instruction trace
* trace\_payload - \[0x73 0x00 0x00 0x00 0x00 0x91 0x82 0x00 0x10\]
...
* This example has no timestamp
* No type field (encoder has no data trace support)
* trace\_payload - \[0x73 0x00 0x00 0x00 0x00 0x91 0x82 0x00 0x10\] carried via the ATDATA bus.
