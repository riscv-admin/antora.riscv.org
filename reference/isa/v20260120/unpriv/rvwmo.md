# 18.1. RVWMO Memory Consistency Model, Version 2.0

## [](#memorymodel)18.1\. RVWMO Memory Consistency Model, Version 2.0
...
### [](#rvwmo)18.1.1\. Definition of the RVWMO Memory Model
...
#### [](#rvwmo-primitives)18.1.1.1\. Memory Model Primitives
...
#### [](#mem-dependencies)18.1.1.2\. Syntactic Dependencies
...
* _r_ is a CSR and an implicit source register for_i_, as defined in [18.1.3\. Source and Destination Register Listings](#source-dest-regs)
...
* _r_ is a CSR and an implicit destination register for_i_, as defined in [18.1.3\. Source and Destination Register Listings](#source-dest-regs)
* _r_ is a CSR that aliases with another destination register for _i_

Most non-memory instructions _carry a dependency_ from each of their source registers to each of their destination registers. However, there are exceptions to this rule; see [18.1.3\. Source and Destination Register Listings](#source-dest-regs).
...
#### [](#18-1-1-3-preserved-program-order)18.1.1.3\. Preserved Program Order
...
#### [](#18-1-1-4-memory-model-axioms)18.1.1.4\. Memory Model Axioms
...
##### [](#ax-load)18.1.1.4.1\. Load Value Axiom
...
##### [](#ax-atom)18.1.1.4.2\. Atomicity Axiom
...
### [](#source-dest-regs)18.1.3\. Source and Destination Register Listings

This section provides a concrete listing of the source and destination registers for each instruction. These listings are used in the definition of syntactic dependencies in[18.1.1.2\. Syntactic Dependencies](#mem-dependencies).
