# 1.1. RV32I Base Integer Instruction Set, Version 2.1

## [](#rv32)1.1\. RV32I Base Integer Instruction Set, Version 2.1
...
### [](#1-1-1-programmers-model-for-base-integer-isa)1.1.1\. Programmers' Model for Base Integer ISA
...
### [](#1-1-2-base-instruction-formats)1.1.2\. Base Instruction Formats
...
### [](#1-1-3-immediate-encoding-variants)1.1.3\. Immediate Encoding Variants
...
### [](#1-1-4-integer-computational-instructions)1.1.4\. Integer Computational Instructions
...
#### [](#1-1-4-1-integer-register-immediate-instructions)1.1.4.1\. Integer Register-Immediate Instructions
...
#### [](#1-1-4-2-integer-register-register-instructions)1.1.4.2\. Integer Register-Register Instructions
...
#### [](#1-1-4-3-nop-instruction)1.1.4.3\. NOP Instruction
...
### [](#1-1-5-control-transfer-instructions)1.1.5\. Control Transfer Instructions
...
#### [](#1-1-5-1-unconditional-jumps)1.1.5.1\. Unconditional Jumps
...
#### [](#1-1-5-2-conditional-branches)1.1.5.2\. Conditional Branches
...
### [](#ldst)1.1.6\. Load and Store Instructions
...
### [](#fence)1.1.7\. Memory Ordering Instructions
...
### [](#ecall-ebreak)1.1.8\. Environment Call and Breakpoints
...
### [](#1-1-9-hint-instructions)1.1.9\. HINT Instructions
...
| |  slli x0, x0, 0x1f and srai x0, x0, 7 were previously designated as custom HINTs, but they have been appropriated for use in semihosting calls, as described in [1.1.8\. Environment Call and Breakpoints](#ecall-ebreak). To reflect their usage in practice, the base ISA spec has been changed to designate them as standard HINTs. |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
