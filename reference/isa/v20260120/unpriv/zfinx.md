...
The Zfinx extension adds all of the instructions that the F extension adds, _except_ for the transfer instructions FLW, FSW, FMV.W.X, FMV.X.W, C.FLW\[SP\], and C.FSW\[SP\].
...
Floating-point operations that produce _w_ < XLEN-bit results fill bits XLEN-1: _w_ with copies of bit _w_\-1 (the sign bit).
...
The Zdinx extension adds all of the instructions that the D extension adds, _except_ for the transfer instructions FLD, FSD, FMV.D.X, FMV.X.D, C.FLD\[SP\], and C.FSD\[SP\].
...
The Zhinx extension adds all of the instructions that the Zfh extension adds, _except_ for the transfer instructions FLH, FSH, FMV.H.X, and FMV.X.H.
