...
We treat these operands as a vector of one or more _element groups_ as defined in [Vector Element Groups](v-st-ext.html#vector-element-groups).
...
| ----------------- | --------------------- | --- | --- | --- |
| AES               | [Zvkned](#zvkned)     | 128 | 32  | 4   |
| SHA256            | [zvknh\[ab\]](#zvknh) | 128 | 32  | 4   |
| SHA512            | [zvknhb](#zvknh)      | 256 | 64  | 4   |
| GCM               | [Zvkg](#zvkg)         | 128 | 32  | 4   |
| SM4               | [Zvksed](#zvksed)     | 128 | 32  | 4   |
| SM3               | [Zvksh](#zvksh)       | 256 | 32  | 8   |

| |  Element Group Width (EGW) - total number of bits in an element group Effective Element Width (EEW) - number of bits in each element Element Group Size (EGS) - number of elements in an element group |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
For element-group instructions, `LMUL`\*`VLEN` must always be at least as large as `EGW`, otherwise an_illegal-instruction exception_ is raised, even if `vl`\=0.
...
Some Vector Crypto instructions are only defined for a specific `SEW`. In such a case all other `SEW` values are _reserved_.
...
Since most of the _cryptography-specific_ instructions have an `EGW`\=128, nothing special needs to be done for these instructions to support implementations with `VLEN`\=128.
...
While the doubling of `LMUL` for these instructions is _safe_ for implementations with `VLEN` ≥ 256, it may be less optimal as it will result in unnecessary register pressure and might exact a performance penalty in some microarchitectures. Therefore, we suggest that in addition to providing portable code for SHA-512 and SM3, libraries should also include more optimal code for these instructions when `VLEN` ≥ 256.
...
The [Zvknhb](#zvknh) and [Zvbc](#zvbc) Vector Crypto Extensions --and accordingly the composite extensions [Zvkn](#zvkn), [Zvknc](#zvknc), [Zvkng](#zvkng), and [Zvksc](#zvksc)\-- depend on Zve64x.
...
| |  This extension is a superset of the [Zvkb](#zvkb) extension. |
| --------------------------------------------------------------- |

| Mnemonic           | Instruction                                        |
| ------------------ | -------------------------------------------------- |
| vandn.\[vv,vx\]    | [Vector And-Not](#insns-vandn)                     |
| vbrev.v            | [Vector Reverse Bits in Elements](#insns-vbrev)    |
| vbrev8.v           | [Vector Reverse Bits in Bytes](#insns-vbrev8)      |
| vrev8.v            | [Vector Reverse Bytes](#insns-vrev8)               |
| vclz.v             | [Vector Count Leading Zeros](#insns-vclz)          |
| vctz.v             | [Vector Count Trailing Zeros](#insns-vctz)         |
| vcpop.v            | [Vector Population Count](#insns-vcpop)            |
...
GHASHH is defined in the "Recommendation for Block Cipher Modes of Operation: Galois/Counter Mode (GCM) and GMAC" \[[45](../biblio/bibliography.html#bib-nist:gcm)\] (NIST Specification).
...
| SEW | EGW | Mnemonic         | Instruction                                          |
| --- | --- | ---------------- | ---------------------------------------------------- |
| 32  | 128 | vaesef.\[vv,vs\] | [Vector AES encrypt final round](#insns-vaesef)      |
| 32  | 128 | vaesem.\[vv,vs\] | [Vector AES encrypt middle round](#insns-vaesem)     |
| 32  | 128 | vaesdf.\[vv,vs\] | [Vector AES decrypt final round](#insns-vaesdf)      |
| 32  | 128 | vaesdm.\[vv,vs\] | [Vector AES decrypt middle round](#insns-vaesdm)     |
| 32  | 128 | vaeskf1.vi       | [Vector AES-128 Forward KeySchedule](#insns-vaeskf1) |
...
There are other various sources available that describe the SM4 block cipher. While not the final version of the standard,[RFC 8998 ShangMi (SM) Cipher Suites for TLS 1.3](https://www.rfc-editor.org/rfc/rfc8998.html)is useful and easy to access.
...
There are other various sources available that describe the SM3 secure hash. While not the final version of the standard,[RFC 8998 ShangMi (SM) Cipher Suites for TLS 1.3](https://www.rfc-editor.org/rfc/rfc8998.html)is useful and easy to access.
...
![svg](_images/svg-0436f29b326c9ce26cc63b0de9cfe34a50adf4cf.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-d3556e94803f25207153ff4891b787e4d63440ed.svg) 
...
![svg](_images/svg-749e00d875e60dc4a0c39a25ee7ee81b67daa98f.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-2c576bc989f66fd2cc3425102010d491e59fea01.svg) 
...
![svg](_images/svg-8d9d4f71862a13a026ec0403bcc4f72daeee1ba2.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-c8d84c7886d494468202ae9b4acc72a814f03509.svg) 
...
![svg](_images/svg-a5d4ab5d27058748594a674d09d39b75d53ab7a7.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-3d2a97fe21c1c911b72a5d62e501ff415387f83c.svg) 
...
![svg](_images/svg-d9aef1b16793a1208a181657fdaa9a0100104fa8.svg) 
...
![svg](_images/svg-0c072004bd58e6c75f21724d7bac8eaa4135c6fd.svg) 
...
![svg](_images/svg-dea1b30b5938622d80627b6f21acf94c37efa8f4.svg) 
...
![svg](_images/svg-9fc7ef19d2258965792b1f3cd783e30f43811d09.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-c3b69b17898da72e1b692fd59c94e3d1baa27b45.svg) 
...
![svg](_images/svg-ae6788e0281df2944e04378cde723594e59db59f.svg) 
...
![svg](_images/svg-617fa36e04cb89f63cdacc5815f8ae89a5c6f4f7.svg) 
...
![svg](_images/svg-0af662c5b6e9ca5c407896f11b38338a1e685944.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-d533c639b139c5b5c54985dd00a369523bac34ff.svg) 
...
![svg](_images/svg-fea30f387ccb854ba59801e5154ba5a784f04b48.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-3e461e13c74a687a2a8ce663609ae55ce8523bc9.svg) 
...
![svg](_images/svg-6d28a25fd429b4d3e9678b20514bef0a3a4eeaf9.svg) 
...
![svg](_images/svg-1a487b445aea78b0eafcbf948f4b53c8f8f8c04d.svg) 
...
![svg](_images/svg-3d4d69ca52b755bdcb3577205930274e12983e39.svg) 
...
![svg](_images/svg-5cb822857c693491e34377f59e0fd737417de939.svg) 
...
| -------- | --------- | --- | --- | --- | ------------------- |
| Vd       | input     | 128 | 4   | 32  | Partial hash (Yi)   |
| Vs1      | input     | 128 | 4   | 32  | Cipher text (Xi)    |
| Vs2      | input     | 128 | 4   | 32  | Hash Subkey (H)     |
| Vd       | output    | 128 | 4   | 32  | Partial-hash (Yi+1) |
...
| |  Since the same hash subkey H will typically be used repeatedly on a given message, a future extension might define a vector-scalar version of this instruction wherevs2 is the scalar element group. This would help reduce register pressure when LMUL \> 1. |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![svg](_images/svg-eb4deead0ddbe25943eccb5e88c2c63a5277156b.svg) 
...
| |  Since the same multiplicand will typically be used repeatedly on a given message, a future extension might define a vector-scalar version of this instruction wherevs2 is the scalar element group. This would help reduce register pressure when LMUL \> 1. |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![svg](_images/svg-51d89973e1c95fe78acebcdfe68c2230fd245e7d.svg) 
...
![svg](_images/svg-19c0a8a3417042fd8f62bfc2ac0df76dfe2941c0.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-a072ab7c86ae05b0eea6cdfd841d844ee60eddcd.svg) 
...
![svg](_images/svg-e15ba3ecbb8f69e0606ecc46015034c20e7260c8.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-c434188a88a73537c8cbb7ed0279a85f6b303ac0.svg) 

Encoding (Vector-Immediate)

![svg](_images/svg-a067c944244844a5fa089155a2d798c4c9b6f7c4.svg) 
...
![svg](_images/svg-aef17ff995653d1cecd330709d1da1a86823d3fc.svg) 

Encoding (Vector-Vector) Low part

![svg](_images/svg-081b53055c613deda6a7664e0eefa2c590afdbdc.svg) 
...
![svg](_images/svg-b2d06559aaa52915dce8503073077abcea54704b.svg) 
...
| |  Note to software developers The first 16 SEW-sized words of the message schedule come from the _message block_in big-endian byte order. Since this instruction treats all words as little endian, software is required to endian swap these words. All of the subsequent message schedule words are produced by this instruction and therefore do not require an endian swap. |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

| |  Note to software developers Software is required to pack the words into element groups as shown above in the arguments table. The indices indicate the relate age with lower indices indicating older words. |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

| |  Note to software developers The {W11, W10, W9, W4} element group can easily be formed by using a vector vmerge instruction with the appropriate mask (for example with vl=4 and 4b0001as the 4 mask bits) vmerge.vvm {W11, W10, W9, W4}, {W11, W10, W9, W8}, {W7, W6, W5, W4}, V0 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
![svg](_images/svg-1420dacd869e5e6d020b0211712a3ed89315b40f.svg) 
...
![svg](_images/svg-c378acaaf1493883cd05b0eb6bcf2ba040be9ef1.svg) 
...
![svg](_images/svg-f6e3390f9eadcc2217beb6365662ea4b99efaa1c.svg) 
...
![svg](_images/svg-ca751c7e470bc683eaaeff3bcab016a89c3dbfaf.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-c377a78ab9ebd53bf89d9c6224405430add5e6e5.svg) 
...
| |  For the first four rounds of encryption, the _current state_ is the plain text. For the first four rounds of decryption, the _current state_ is the cipher text. For all subsequent rounds, the _current state_ is the _next state_ from the previous four rounds. |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![svg](_images/svg-0a7394233471b3a363fdae1fc6cdac4ed01cc8ac.svg) 

Encoding (Vector-Scalar)

![svg](_images/svg-717098c95cd2151bf91aa529db7596490080c84c.svg) 

Encoding (Vector-Immediate)

![svg](_images/svg-9b819e3fec0029975dccc35a34ea05402957b95d.svg) 
...
__Table 2\. VAES.vv and VAES.vs encoding space__
| vs1   |        |
| ----- | ------ |
| 00000 | vaesdm |
| 00001 | vaesdf |
...
__Table 3\. VXUNARY0 encoding space__
| vs1   |            |
| ----- | ---------- |
| 00010 | vzext.vf8  |
| 00011 | vsext.vf8  |
