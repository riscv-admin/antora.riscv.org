...
The \_LPI object uses a “Resource Descriptor”, which is formatted per[\[resource\_descriptor\_encoding\]](#resource%5Fdescriptor%5Fencoding), to specify the entry method for a lower power state. RISC-V systems set the resource descriptor as specified in[Table 1](#table%5Flpi%5Fentry%5Fmethod):
...
[\[lpi\_examples\]](#lpi%5Fexamples) provides examples for both a WFI entry method and SBI HSM hart suspend entry methods.
...
The \_CPC object may use a “Resource Descriptor”, which is formatted per[\[resource\_descriptor\_encoding\]](#resource%5Fdescriptor%5Fencoding), for many of its fields. When using an FFH Resource Descriptor for a \_CPC field, it must be formatted as specified in[Table 4](#table%5Fcpc%5Fresource%5Fdescriptor):
...
[\[cppc\_examples\]](#cppc%5Fexamples) provides examples for both a CSR access and an SBI CPPC access.
