# 6.1. BRS-I SMBIOS Requirements

## [](#smbios)6.1\. BRS-I SMBIOS Requirements
...
| SMBIOS\_020                                                                                                                          | Processor Information (Type 04) structures, meeting the additional [6.1.1\. Type 04 Processor Information](#smbios-type04) clarifications, MUST be implemented. |
...
### [](#smbios-type04)6.1.1\. Type 04 Processor Information
...
For hart-specific vendor and revision information, please see [6.1.2\. Type 44 Processor-Specific Data](#smbios-type44).

### [](#smbios-type44)6.1.2\. Type 44 Processor-Specific Data
...
| ------ | ------- | ------------------------- | ------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 00h    | 0100h   | Revision                  | WORD   | Varies | See [6.1.3\. Processor-Specific Data Structure Versioning](#smbios-psd-ver).                                                                                                                                                                           |
...
### [](#smbios-psd-ver)6.1.3\. Processor-Specific Data Structure Versioning
