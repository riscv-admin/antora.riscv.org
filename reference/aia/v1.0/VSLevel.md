...
| bits 23:16 | _Reserved for priority number for interrupt 4; reads as zero_  |
| bits 31:24 | Priority number for interrupt 5, supervisor timer interrupt    |
| bits 39:32 | _Reserved for priority number for interrupt 8; reads as zero_  |
...
| |  When hvictl.VTI = 1, the absence of an interrupt for VS level can be indicated only by setting hvictl.IID = 9\. Software might want to use the pair IID = 9, IPRIO = 0 generally to represent _no interrupt_ in hvictl. |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
