...
## [](#chapter2)2.1\. Packet Encapsulation
...
### [](#2-1-1-normal-encapsulation-structure)2.1.1\. Normal Encapsulation Structure
...
| ------------- | ------- | ------------------------------------------------------------------- |
| **header**    | 8       | Encapsulation header. See [2.1.1.1\. Header](#%5Fsection%5FHeader). |
| **srcID**     | 0 - 16  | Source ID. See [2.1.1.2\. srcID](#%5Fsection%5FsrcID).              |
| **timestamp** | T\*8    | Time stamp. See [2.1.1.3\. Timestamp](#%5Fsection%5FTimestamp).     |
| **payload**   | 1-248   | Packet payload. See [2.1.1.4\. Payload](#%5Fsection%5FPayload).     |

The groups are defined in the following sections:

#### [](#%5Fsection%5FHeader)2.1.1.1\. Header
...
| ---------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **length** | 5       | Encapsulated payload length. A value of _L_ indicates an _L_ byte payload. Must be > 0 - see [2.1.2\. Null Encapsulation](#%5Fsection%5Fnull%5Fencapsulation).                                           |
...
#### [](#%5Fsection%5FsrcID)2.1.1.2\. srcID
...
#### [](#%5Fsection%5FPayload)2.1.1.4\. Payload
...
| **trace\_payload** | ≤ R     | Packet payloads such as those defined for E-Trace.Maximum value of R is defined as 248 - Y - **srcID**%8, where Y is the length of the **type** field. See [2.1.1.5\. Packet Length](#%5Fsection%5Fpacket%5Flength) for details of the relationship between **srcID** and payload length. |

#### [](#%5Fsection%5Fpacket%5Flength)2.1.1.5\. Packet Length
...
### [](#%5Fsection%5Fnull%5Fencapsulation)2.1.2\. Null Encapsulation
...
### [](#2-1-3-synchronization)2.1.3\. Synchronization
...
N = 31 + T + S (see [2.1.1.3\. Timestamp](#%5Fsection%5FTimestamp) and [2.1.1.5\. Packet Length](#%5Fsection%5Fpacket%5Flength) for definitions of T and S respectively)
