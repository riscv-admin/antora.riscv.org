...
## [](#5-1-code-models)5.1\. Code models
...
### [](#5-1-1-medium-low-code-model)5.1.1\. Medium low code model
...
| |  The ranges on RV64 are not 0x0 \~ 0x000000007FFFFFFF and0xFFFFFFFF80000000 \~ 0xFFFFFFFFFFFFFFFF due to RISC-V’s sign-extension of immediates; the following code fragments show where the ranges come from: |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
### [](#5-1-2-medium-any-code-model)5.1.2\. Medium any code model
...
### [](#5-1-3-medium-position-independent-code-model)5.1.3\. Medium position independent code model

This model is similar to the medium any code model, but uses the[global offset table](#Global Offset Table) (GOT) for non-local symbol addresses.
