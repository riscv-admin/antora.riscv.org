# 11.1. DWARF Register Numbers

## [](#11-1-dwarf-register-numbers)11.1\. DWARF Register Numbers

The table below lists the mapping from DWARF register numbers to machine registers.

__Table 1\. DWARF register number encodings__
...
The RISC-V specification defines a total of 4096 CSRs (see [dwarf-bib.adoc#riscv-priv](dwarf-bib.html#riscv-priv)). Each CSR is assigned a DWARF register number corresponding to its specified CSR number plus 4096.
