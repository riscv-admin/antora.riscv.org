...
###### [](#overloaded-vector-mask-register-logical)Vector Mask-Register Logical
...
###### [](#overloaded-vector-count-population-in-mask-vcpopm)Vector count population in mask `vcpop.m`
...
###### [](#overloaded-vfirst-find-first-set-mask-bit)`vfirst` find-first-set mask bit
...
###### [](#overloaded-vmsbfm-set-before-first-mask-bit)`vmsbf.m` set-before-first mask bit
...
###### [](#overloaded-vmsifm-set-including-first-mask-bit)`vmsif.m` set-including-first mask bit
...
###### [](#overloaded-vmsofm-set-only-first-mask-bit)`vmsof.m` set-only-first mask bit
...
###### [](#overloaded-vector-iota)Vector Iota Intrinsics

```c
// masked functions
```

###### [](#overloaded-vector-element-index)Vector Element Index Intrinsics
