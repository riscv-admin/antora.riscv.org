...
###### [](#set-vl-and-vtype)Get `vl` with specific vtype
...
###### [](#set-vl-to-vlmax-with-specific-vtype)Get `VLMAX` with specific vtype
...
###### [](#reinterpret-cast-conversion)Reinterpret Cast Conversion Intrinsics
...
###### [](#vector-lmul-extensionn)Vector LMUL Extension Intrinsics
...
###### [](#vector-lmul-truncation)Vector LMUL Truncation Intrinsics
...
###### [](#vector-initialization)Vector Initialization Intrinsics
...
###### [](#vector-insertion)Vector Insertion Intrinsics
...
###### [](#vector-extraction)Vector Extraction Intrinsics
...
###### [](#vector-creation)Vector Creation Intrinsics
