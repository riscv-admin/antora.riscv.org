...
###### [](#vector-mask-register-logical)Vector Mask-Register Logical
...
###### [](#vector-count-population-in-mask-vcpopm)Vector count population in mask `vcpop.m`
...
###### [](#vmsbfm-set-before-first-mask-bit)`vmsbf.m` set-before-first mask bit
...
###### [](#vmsifm-set-including-first-mask-bit)`vmsif.m` set-including-first mask bit
...
###### [](#vmsofm-set-only-first-mask-bit)`vmsof.m` set-only-first mask bit
...
###### [](#vector-iota)Vector Iota Intrinsics
...
###### [](#vector-element-index)Vector Element Index Intrinsics
