...
###### [](#vector-single-width-saturating-add-and-subtract)Vector Single-Width Saturating Add and Subtract Intrinsics
...
###### [](#vector-single-width-averaging-add-and-subtract)Vector Single-Width Averaging Add and Subtract Intrinsics
...
###### [](#vector-single-width-fractional-multiply-with-rounding-and-saturation)Vector Single-Width Fractional Multiply with Rounding and SaturationIntrinsics
...
###### [](#vector-single-width-scaling-shift)Vector Single-Width Scaling Shift Intrinsics
...
###### [](#vector-narrowing-fixed-point-clip)Vector Narrowing Fixed-Point Clip Intrinsics
