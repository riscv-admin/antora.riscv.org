...
###### [](#policy-variant-vector-mask-register-logical)Vector Mask-Register Logical

Intrinsics here don’t have a policy variant.

###### [](#policy-variant-vector-count-population-in-mask-vcpopm)Vector count population in mask `vcpop.m`

Intrinsics here don’t have a policy variant.

###### [](#policy-variant-vfirst-find-first-set-mask-bit)`vfirst` find-first-set mask bit

Intrinsics here don’t have a policy variant.

###### [](#policy-variant-vmsbfm-set-before-first-mask-bit)`vmsbf.m` set-before-first mask bit
...
###### [](#policy-variant-vmsifm-set-including-first-mask-bit)`vmsif.m` set-including-first mask bit
...
###### [](#policy-variant-vmsofm-set-only-first-mask-bit)`vmsof.m` set-only-first mask bit
...
###### [](#policy-variant-vector-iota)Vector Iota Intrinsics
...
###### [](#policy-variant-vector-element-index)Vector Element Index Intrinsics
