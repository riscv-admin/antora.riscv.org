...
##### [](#vector-permutation-intrinsics)Vector Permutation Intrinsics

###### [](#policy-variant-overloadedinteger-scalar-move)Integer and Floating-Point Scalar Move Intrinsics
...
###### [](#policy-variant-overloadedvector-slideup)Vector Slideup Intrinsics
...
###### [](#policy-variant-overloadedvector-slidedown)Vector Slidedown Intrinsics
...
###### [](#policy-variant-overloadedvector-slide1up-and-slide1down)Vector Slide1up and Slide1down Intrinsics
...
###### [](#policy-variant-overloadedvector-register-gather)Vector Register Gather Intrinsics
...
###### [](#policy-variant-overloadedvector-compress)Vector Compress Intrinsics
