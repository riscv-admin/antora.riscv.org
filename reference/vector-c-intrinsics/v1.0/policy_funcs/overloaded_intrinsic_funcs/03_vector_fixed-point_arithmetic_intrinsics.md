...
##### [](#vector-fixed-point-arithmetic-intrinsics)Vector Fixed-Point Arithmetic Intrinsics

###### [](#policy-variant-overloadedvector-single-width-saturating-add-and-subtract)Vector Single-Width Saturating Add and Subtract Intrinsics
...
###### [](#policy-variant-overloadedvector-single-width-averaging-add-and-subtract)Vector Single-Width Averaging Add and Subtract Intrinsics
...
###### [](#policy-variant-overloadedvector-single-width-fractional-multiply-with-rounding-and-saturation)Vector Single-Width Fractional Multiply with Rounding and SaturationIntrinsics
...
###### [](#policy-variant-overloadedvector-single-width-scaling-shift)Vector Single-Width Scaling Shift Intrinsics
...
###### [](#policy-variant-overloadedvector-narrowing-fixed-point-clip)Vector Narrowing Fixed-Point Clip Intrinsics
