...
##### [](#vector-mask-intrinsics)Vector Mask Intrinsics

###### [](#policy-variant-overloadedvector-mask-register-logical)Vector Mask-Register Logical

Intrinsics here don’t have a policy variant.

###### [](#policy-variant-overloadedvector-count-population-in-mask-vcpopm)Vector count population in mask `vcpop.m`

Intrinsics here don’t have a policy variant.

###### [](#policy-variant-overloadedvfirst-find-first-set-mask-bit)`vfirst` find-first-set mask bit

Intrinsics here don’t have a policy variant.

###### [](#policy-variant-overloadedvmsbfm-set-before-first-mask-bit)`vmsbf.m` set-before-first mask bit
...
###### [](#policy-variant-overloadedvmsifm-set-including-first-mask-bit)`vmsif.m` set-including-first mask bit
...
###### [](#policy-variant-overloadedvmsofm-set-only-first-mask-bit)`vmsof.m` set-only-first mask bit
...
###### [](#policy-variant-overloadedvector-iota)Vector Iota Intrinsics
...
###### [](#policy-variant-overloadedvector-element-index)Vector Element Index Intrinsics
