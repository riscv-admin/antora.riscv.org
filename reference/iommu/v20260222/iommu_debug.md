...
* `tr_req_iova` ([iommu\_registers.adoc#TRR\_IOVA](iommu%5Fregisters.html#TRR%5FIOVA))
* `tr_req_ctl` ([iommu\_registers.adoc#TRR\_CTRL](iommu%5Fregisters.html#TRR%5FCTRL))

The translation-response interface consists of a single 64-bit RO register`tr_response` ([iommu\_registers.adoc#TRR\_RSP](iommu%5Fregisters.html#TRR%5FRSP))
